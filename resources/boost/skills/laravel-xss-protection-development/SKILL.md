...
description: Application integration guidance for protonemedia/laravel-xss-protection.
license: MIT
metadata:
  author: ProtoneMedia
---
...
## Overview
Use `protonemedia/laravel-xss-protection.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-xss-protection.` classes, facades, config, or documented features.
